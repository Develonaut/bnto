...
// Pure rename logic lives in rename.rs (testable natively); this file only
// handles the WASM boundary conversion.
...
// =============================================================================
//
// Calls process() ONCE and returns a JS object with both the metadata JSON
// string and raw output bytes.
