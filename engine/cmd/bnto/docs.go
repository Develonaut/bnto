// Package main implements the docs command for viewing bnto documentation.
//
...
var docsCmd = &cobra.Command{
	Use:   "docs [doc-name]",
	Short: "View bnto documentation",
	Long: `View bnto documentation in beautiful markdown format.
...
func runDocs(cmd *cobra.Command, args []string) error {
	...
	if !ok {
		return fmt.Errorf("unknown doc: %s\nRun 'bnto docs --help' to see available docs", docName)
	}
