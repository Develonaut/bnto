// Package main provides output formatting utilities for the bnto CLI.
//
...
// Uses bnto box emoji for branding on "Running bnto:" messages.
func printInfo(message string) {
	if strings.HasPrefix(message, "Running bnto:") {
		fmt.Printf("🍱 %s\n", message)
		return
	}
