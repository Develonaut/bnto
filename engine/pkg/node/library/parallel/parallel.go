...
//
// The parallel node executes multiple tasks concurrently with configurable:
...
// Parallel implements the parallel node for concurrent task execution.
type Parallel struct{}

// New creates a new parallel node instance.
func New() *Parallel {
	return &Parallel{}
}
