...
// New creates a new edit-fields node instance.
//
...
//	_context (optional): Execution context from previous node (for templates)
//
...
// Verify EditFields implements node.Executable at compile time
var _ node.Executable = (*EditFields)(nil)
