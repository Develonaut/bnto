...
import { StationNode, type StationNodeType } from "./StationNode";
import { ConveyorEdge, type ConveyorEdgeType } from "./ConveyorEdge";
...
export function ConveyorCanvas({
  ...
  const edgeTypes = useMemo(() => ({ conveyor: ConveyorEdge }), []);
