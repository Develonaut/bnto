...
export function ColorSwatches() {
  return (
    <Grid cols={6} rows={4} gap="md" animated>
      ...
      <GridItem colSpan={2} rowSpan={2} colStart={2} rowStart={3}>
        <Swatch
          name="Success"
          bg="bg-success"
      ...
      <GridItem rowSpan={2} colStart={4} rowStart={3}>
        <Swatch
          name="Warning"
          bg="bg-warning"
