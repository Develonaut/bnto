...
/**
 * Custom React Flow node that renders as a .depth Card — the "building"
 * on our Mini Motorways map.
 *
 * Each station has:
 * - A depth Card with color variant (primary, secondary, accent, etc.)
...
export function StationNode({ data }: NodeProps<StationNodeType>) {
  ...
  return (
    <div className="relative">
       ...
       * animation from the depth Card's preserve-3d. Each station
