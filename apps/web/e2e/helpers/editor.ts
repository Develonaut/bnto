 ...
 * This navigates to the tool page, uploads a fixture file to advance
 * the stepper, then clicks "Edit in editor" — just like a real user.
 *
...
export async function dismissBetaDialog(page: Page) {
  ...
  // force: true bypasses pointer interception from tooltips or overlapping elements
  await dialog.getByTestId("beta-get-started").click({ force: true });
