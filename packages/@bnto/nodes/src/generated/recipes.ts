...
export const GENERATED_RECIPES: readonly GeneratedRecipe[] = [
  ...
  },
  {
    ...
    name: "Optimize SVG",
    description:
      "Optimize SVG files by removing unnecessary metadata, comments, and optimizing paths. Free, no signup.",
    category: "vector",
    tags: ["SVG", "Optimize", "Minify", "Remove metadata", "Browser-based"] as const,
    definition: {
      edges: [
        {
          id: "e1",
      ...
      metadata: {
        ...
        description:
          "Optimize SVG files by removing unnecessary metadata, comments, and optimizing paths. Free, no signup.",
        tags: ["SVG", "Optimize", "Minify", "Remove metadata", "Browser-based"],
      },
      name: "Optimize SVG",
      nodes: [
        {
