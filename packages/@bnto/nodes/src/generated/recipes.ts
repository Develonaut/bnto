...
export const GENERATED_RECIPES: readonly GeneratedRecipe[] = [
  ...
  {
    slug: "bulk-video-download",
    name: "Bulk Video Download",
    description:
      "Download and organize videos from a CSV manifest. Each row provides a URL and optional group folder. Requires yt-dlp and ffmpeg. CLI/desktop only.",
    category: "video",
    tags: ["CSV manifest", "Bulk download", "yt-dlp", "Video organization"] as const,
    definition: {
      edges: [
        {
          id: "e1",
      ...
      metadata: {
        ...
        description:
          "Download and organize videos from a CSV manifest. Each row provides a URL and optional group folder. Requires yt-dlp and ffmpeg. CLI/desktop only.",
        tags: ["CSV manifest", "Bulk download", "yt-dlp", "Video organization"],
      },
      name: "Bulk Video Download",
      nodes: [
        {
          ...
          parameters: {
            ...
            mode: "file-upload",
            multiple: false,
            placeholder: "manifest.csv (columns: group, url)",
          },
          position: {
            x: 0,
            y: 100,
