 ...
 *
 * Must be rendered inside BentoAuthProvider (which handles server-side auth
 * state). Creates a ConvexReactClient and wires it through:
 *   ConvexAuthNextjsProvider → ConvexQueryClient → QueryClientProvider
 *
 * This makes useConvex(), useConvexAuth(), and all @bento/core hooks work.
 */
export function BentoCoreProvider({
  children,
}: {
